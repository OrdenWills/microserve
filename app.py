...
def load_model(model,path='best_model_todate.weights.h5'):
...
def index():
    filename = 'best_model_todate.weights.h5'  # Specify the filename you want to save the downloaded file as
